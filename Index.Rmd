...
snail_island_shp_utm4N <- st_transform(snail_island_shp, "+proj=utm +zone=4 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs")
```
...
if (!file.exists(paste("Data/Environmental_data/Elevation/Tif/LH20_Elev_220.Rdata", sep=""))){
  ...
  elevation <- projectRaster(elevation, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Existing Vegetation Cover 2022/Tif/LH22_EVC_220.Rdata", sep=""))){
  ...
  existing_vegetation_cover <- projectRaster(existing_vegetation_cover, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Existing Vegetation Height 2022/Tif/LH22_EVH_220.Rdata", sep=""))){
  ...
  existing_vegetation_height <- projectRaster(existing_vegetation_height, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Existing Vegetation Type/Tif/LH20_EVT_220.Rdata", sep=""))){
  ...
  existing_vegetation_type <- projectRaster(existing_vegetation_type, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Forest Canopy Base Height 2022/Tif/LH22_CBH_220.Rdata", sep=""))){
  ...
  forest_canopy_base_height <- projectRaster(forest_canopy_base_height, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Forest Canopy Bulk Density 2022/Tif/LH22_CBD_220.Rdata", sep=""))){
  ...
  forest_canopy_bulk_density <- projectRaster(forest_canopy_bulk_density, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Forest Canopy Cover 2022/Tif/LH22_CC_220.Rdata", sep=""))){
  ...
  forest_canopy_cover <- projectRaster(forest_canopy_cover, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Forest Canopy Height 2022/Tif/LH22_CH_220.Rdata", sep=""))){
  ...
  forest_canopy_height <- projectRaster(forest_canopy_height, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Slope Degrees/Tif/LH20_SlpD_220.Rdata", sep=""))){
  ...
  slope_degrees <- projectRaster(slope_degrees, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Slope Percent Rise/Tif/LH20_SlpP_220.Rdata", sep=""))){
  ...
  slope_percent_rise <- projectRaster(slope_percent_rise, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Soil Fertility Class/FertilityClass_State_wgs84.shp", sep=""))){
  ...
  soil_fertility_class <- project(soil_fertility_class, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Soil Nutrient Holding Capacity/CEC_State_wgs84.shp", sep=""))){
  ...
  soil_nutrient_holding_capacity <- project(soil_nutrient_holding_capacity, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Soil Organic Matter/OrganicMatter_State_wgs84.shp", sep=""))){
  ...
  soil_organic_matter <- project(soil_organic_matter, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Soil pH/pH_State_wgs84.shp", sep=""))){
  ...
  soil_ph <- project(soil_ph, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Soil Shrink and Swell/ShrinkSwell_State_wgs84.shp", sep=""))){
  ...
  soil_shrink_and_swell <- project(soil_shrink_and_swell, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/Soil Water Permeability/WaterPermeability_State_wgs84.shp", sep=""))){
  ...
  soil_water_permeability <- project(soil_water_permeability, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/TNC Ecosystems Before and Current/Before_Ecosystems_wgs84.shp", sep=""))){
  ...
  tnc_before <- project(tnc_before, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
...
if (!file.exists(paste("Data/Environmental_data/TNC Ecosystems Before and Current/Current_Ecosystems_wgs84.shp", sep=""))){
  ...
  tnc_current <- project(tnc_current, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
