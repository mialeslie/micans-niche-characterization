...
#replace this to change shapefile used - "bigisland", "lanai", "maui", "molokai", "kauai", "oahu"
chosen_island <- "oahu"
chosen_map <- get(paste(chosen_island, "_shp", sep = ""))

plot(chosen_map)
#Create an NAD83 shapefile for later
chosen_map_nad83 <- st_transform(chosen_map, "+proj=aea +lat_0=13 +lon_0=-157 +lat_1=8 +lat_2=18 +x_0=0 +y_0=0 +datum=NAD83 +units=m +no_defs")
chosen_map_utm4N <- st_transform(chosen_map, "+proj=utm +zone=4 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs")

```

### Mountain shapefiles

#### Create mountain shapfiles
```{r include=FALSE}
...
elevation_cut <- projectRaster(elevation_cut, crs="+proj=utm +zone=4 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs")
...
#waianaes
extent_to_filter <- ext(576549.6, 599000, 2354081, 2396270)
...
#koolaus
extent_to_filter <- ext(599000, 637460.8, 2354081, 2396270)
selected_polygons <- crop(elevation_polygon, extent_to_filter)
plot(selected_polygons)
...
bioclim_variables <- mask(bioclim_variables, chosen_map)
bioclim_variables <- crop(bioclim_variables, chosen_map)
...
### Elevation
```{r}
if (!file.exists(paste("Data/Environmental_data/Elevation/Tif/LH20_Elev_220_", chosen_island, ".Rdata", sep=""))){
  elevation <- raster("Data/Environmental_data/Elevation/Tif/LH20_Elev_220.tif")
  elevation_cut <- crop(elevation, chosen_map_nad83)
  elevation_cut <- mask(elevation_cut, chosen_map_nad83)
  #this takes a while to run
  elevation_cut <- projectRaster(elevation_cut, cloud_frequency_cut)
  save(elevation_cut, file = paste("Data/Environmental_data/Elevation/Tif/LH20_Elev_220_", chosen_island, ".Rdata", sep=""))
  rm(elevation)
  gc()
} else {
  load(paste("Data/Environmental_data/Elevation/Tif/LH20_Elev_220_", chosen_island, ".Rdata", sep=""))
}
...
```{r}
if (!file.exists(paste("Data/Environmental_data/Existing Vegetation Cover 2022/Tif/LH22_EVC_220_", chosen_island, ".Rdata", sep=""))){
  existing_vegetation_cover <- raster("Data/Environmental_data/Existing Vegetation Cover 2022/Tif/LH22_EVC_220.tif")
  existing_vegetation_cover_cut <- crop(existing_vegetation_cover, chosen_map_nad83)
  existing_vegetation_cover_cut <- mask(existing_vegetation_cover_cut, chosen_map_nad83)
  #this takes a while to run
  existing_vegetation_cover_cut <- projectRaster(existing_vegetation_cover_cut, cloud_frequency_cut)
  
  save(existing_vegetation_cover_cut, file = paste("Data/Environmental_data/Existing Vegetation Cover 2022/Tif/LH22_EVC_220_", chosen_island, ".Rdata", sep=""))
  rm(existing_vegetation_cover)
  gc()
} else {
  load(paste("Data/Environmental_data/Existing Vegetation Cover 2022/Tif/LH22_EVC_220_", chosen_island, ".Rdata", sep=""))
}
...
```{r}
if (!file.exists(paste("Data/Environmental_data/Existing Vegetation Height 2022/Tif/LH22_EVH_220_", chosen_island, ".Rdata", sep=""))){
  existing_vegetation_height <- raster("Data/Environmental_data/Existing Vegetation Height 2022/Tif/LH22_EVH_220.tif")
  existing_vegetation_height_cut <- crop(existing_vegetation_height, chosen_map_nad83)
  existing_vegetation_height_cut <- mask(existing_vegetation_height_cut, chosen_map_nad83)
  #this takes a while to run
  existing_vegetation_height_cut <- projectRaster(existing_vegetation_height_cut, cloud_frequency_cut)
  
  save(existing_vegetation_height_cut, file = paste("Data/Environmental_data/Existing Vegetation Height 2022/Tif/LH22_EVH_220_", chosen_island, ".Rdata", sep=""))
  rm(existing_vegetation_height)
  gc()
} else {
  load(paste("Data/Environmental_data/Existing Vegetation Height 2022/Tif/LH22_EVH_220_", chosen_island, ".Rdata", sep=""))
}
...
```{r}
#Existing Vegetation Type 2022
if (!file.exists(paste("Data/Environmental_data/Existing Vegetation Type/Tif/LH20_EVT_220_", chosen_island, ".Rdata", sep=""))){
  existing_vegetation_type <- raster("Data/Environmental_data/Existing Vegetation Type/Tif/LH20_EVT_220.tif")
  existing_vegetation_type_cut <- crop(existing_vegetation_type, chosen_map_nad83)
  existing_vegetation_type_cut <- mask(existing_vegetation_type_cut, chosen_map_nad83)
  levels <- levels(existing_vegetation_type_cut)[[1]][c(1, 2)]
  #this takes a while to run
  existing_vegetation_type_cut <- projectRaster(existing_vegetation_type_cut, cloud_frequency_cut)
  
  save(existing_vegetation_type_cut, file = paste("Data/Environmental_data/Existing Vegetation Type/Tif/LH20_EVT_220_", chosen_island, ".Rdata", sep=""))
  save(levels, file = paste("Data/Environmental_data/Existing Vegetation Type/Tif/LH20_EVT_220_", chosen_island, "_levels.Rdata", sep=""))
  rm(existing_vegetation_type)
  gc()
} else {
  load(paste("Data/Environmental_data/Existing Vegetation Type/Tif/LH20_EVT_220_", chosen_island, ".Rdata", sep=""))
  load(file = paste("Data/Environmental_data/Existing Vegetation Type/Tif/LH20_EVT_220_", chosen_island, "_levels.Rdata", sep=""))
}
...
```{r}
if (!file.exists(paste("Data/Environmental_data/Forest Canopy Base Height 2022/Tif/LH22_CBH_220_", chosen_island, ".Rdata", sep=""))){
  forest_canopy_base_height <- raster("Data/Environmental_data/Forest Canopy Base Height 2022/Tif/LH22_CBH_220.tif")
  forest_canopy_base_height_cut <- crop(forest_canopy_base_height, chosen_map_nad83)
  forest_canopy_base_height_cut <- mask(forest_canopy_base_height_cut, chosen_map_nad83)
  #this takes a while to run
  forest_canopy_base_height_cut <- projectRaster(forest_canopy_base_height_cut, cloud_frequency_cut)
  
  save(forest_canopy_base_height_cut, file = paste("Data/Environmental_data/Forest Canopy Base Height 2022/Tif/LH22_CBH_220_", chosen_island, ".Rdata", sep=""))
  rm(forest_canopy_base_height)
  gc()
} else {
  load(paste("Data/Environmental_data/Forest Canopy Base Height 2022/Tif/LH22_CBH_220_", chosen_island, ".Rdata", sep=""))
}
...
```{r}
if (!file.exists(paste("Data/Environmental_data/Forest Canopy Bulk Density 2022/Tif/LH22_CBD_220_", chosen_island, ".Rdata", sep=""))){
  forest_canopy_bulk_density <- raster("Data/Environmental_data/Forest Canopy Bulk Density 2022/Tif/LH22_CBD_220.tif")
  forest_canopy_bulk_density_cut <- crop(forest_canopy_bulk_density, chosen_map_nad83)
  forest_canopy_bulk_density_cut <- mask(forest_canopy_bulk_density_cut, chosen_map_nad83)
  #this takes a while to run
  forest_canopy_bulk_density_cut <- projectRaster(forest_canopy_bulk_density_cut, cloud_frequency_cut)
  save(forest_canopy_bulk_density_cut, file = paste("Data/Environmental_data/Forest Canopy Bulk Density 2022/Tif/LH22_CBD_220_", chosen_island, ".Rdata", sep=""))
  rm(forest_canopy_bulk_density)
  gc()
} else {
  
  load(paste("Data/Environmental_data/Forest Canopy Bulk Density 2022/Tif/LH22_CBD_220_", chosen_island, ".Rdata", sep=""))
}
...
```{r}
if (!file.exists(paste("Data/Environmental_data/Forest Canopy Cover 2022/Tif/LH22_CC_220_", chosen_island, ".Rdata", sep=""))){
  forest_canopy_cover <- raster("Data/Environmental_data/Forest Canopy Cover 2022/Tif/LH22_CC_220.tif")
  forest_canopy_cover_cut <- crop(forest_canopy_cover, chosen_map_nad83)
  forest_canopy_cover_cut <- mask(forest_canopy_cover_cut, chosen_map_nad83)
  #this takes a while to run
  forest_canopy_cover_cut <- projectRaster(forest_canopy_cover_cut, cloud_frequency_cut)
  save(forest_canopy_cover_cut, file = paste("Data/Environmental_data/Forest Canopy Cover 2022/Tif/LH22_CC_220_", chosen_island, ".Rdata", sep=""))
  rm(forest_canopy_cover)
  gc()
} else {
  
  load(paste("Data/Environmental_data/Forest Canopy Cover 2022/Tif/LH22_CC_220_", chosen_island, ".Rdata", sep=""))
}
...
```{r}
if (!file.exists(paste("Data/Environmental_data/Forest Canopy Height 2022/Tif/LH22_CH_220_", chosen_island, ".Rdata", sep=""))){
  forest_canopy_height <- raster("Data/Environmental_data/Forest Canopy Height 2022/Tif/LH22_CH_220.tif")
  forest_canopy_height_cut <- crop(forest_canopy_height, chosen_map_nad83)
  forest_canopy_height_cut <- mask(forest_canopy_height_cut, chosen_map_nad83)
  #this takes a while to run
  forest_canopy_height_cut <- projectRaster(forest_canopy_height_cut, cloud_frequency_cut)
  save(forest_canopy_height_cut, file = paste("Data/Environmental_data/Forest Canopy Height 2022/Tif/LH22_CH_220_", chosen_island, ".Rdata", sep=""))
  rm(forest_canopy_height)
  gc()
} else {
  load(paste("Data/Environmental_data/Forest Canopy Height 2022/Tif/LH22_CH_220_", chosen_island, ".Rdata", sep=""))
}
...
### Slope Degrees
```{r}
if (!file.exists(paste("Data/Environmental_data/Slope Degrees/Tif/LH20_SlpD_220_", chosen_island, ".Rdata", sep=""))){
  slope_degrees <- raster("Data/Environmental_data/Slope Degrees/Tif/LH20_SlpD_220.tif")
  slope_degrees_cut <- crop(slope_degrees, chosen_map_nad83)
  slope_degrees_cut <- mask(slope_degrees_cut, chosen_map_nad83)
  #this takes a while to run
  slope_degrees_cut <- projectRaster(slope_degrees_cut, cloud_frequency_cut)
  save(slope_degrees_cut, file = paste("Data/Environmental_data/Slope Degrees/Tif/LH20_SlpD_220_", chosen_island, ".Rdata", sep=""))
  rm(slope_degrees)
  gc()
} else {
  load(paste("Data/Environmental_data/Slope Degrees/Tif/LH20_SlpD_220_", chosen_island, ".Rdata", sep=""))
}
